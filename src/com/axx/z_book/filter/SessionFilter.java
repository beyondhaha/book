...
@WebFilter(urlPatterns = {"*.do", "*.html"},
        initParams = {@WebInitParam(name = "bai", value = "/book/page.do?operate=page&page=user/login,/book/page.do?operate=page&page=user/regist,/book/user.do?null")})
